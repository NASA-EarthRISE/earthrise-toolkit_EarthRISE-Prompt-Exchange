...
MIDDLEWARE = [
    ...
    'prompts.middleware.EarthRISEAccessMiddleware',
]

ROOT_URLCONF = 'nasa_prompts.urls'
...
WSGI_APPLICATION = 'nasa_prompts.wsgi.application'
...
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'America/New_York'  # NASA Goddard timezone
USE_I18N = True
USE_TZ = True
...
SOCIALACCOUNT_ADAPTER = 'prompts.adapters.CustomSocialAccountAdapter'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@nasa-prompts.gov')
